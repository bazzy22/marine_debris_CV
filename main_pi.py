...
class StereoConfig:
    ...
    focal_length: float = 1000.0   # Calibrated focal length in pixels
    ...
    match_patch_size: int = 16       # Template patch side length, pixels
    match_search_range: int = 96     # Max disparity searched, pixels
